            ...
            case self::OBJECT_CREATED:
            {
                ...
                else
                {
                    if (!is_object( $thePayment )) {
                        $this->logger->writeTimedString( "Error. unable to fetch PaymentObject for process $processID", __METHOD__ );
                    } else {
                        $this->logger->writeTimedString( "Error. Payment rejected: payment status 'not approved' for process $processID", __METHOD__ );
                    }
                }
                //___end____
